...
In the visual below, I have highlighted the change in Eco Footprint, Total Coral Area, and Restored Area over time on the site-level.  Please note that the Total Coral Area and Restored Area often share the same values or can be quite similar.
...
At Yellowman B, Bonaire Reef Renewal outplanted different genotypes.  Only geno #1 overlaps between Yellowman A and Yellowman B.
...
The percentage of Bottom Contact stressors declines greatly between the 3- and 6-month surveys.  It seems plausible that the strength of the adhesive could play an important role maintaining stability as new corals establish their natural connections with the environment. 
