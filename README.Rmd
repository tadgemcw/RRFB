...
### Yellowman C 6-Month Survey
```



**Carl's Hill 3-Month Survey: Ranking Genotypes by Average Tissue Health**
```{r, carls hill 3 month weighted coral health by geno, echo=FALSE}
carl_health <- carl3 %>%
...
```{r, yellowman3A calculating A3 weighted coral health by geno, echo=FALSE }
...
```{r yellowmanA6 calculating 6A weighted coral health by geno, echo=FALSE }
...
```{r yellowmanB3 calculating B3 weighted coral health by geno, echo=FALSE }
...
```{r yellowmanB6 calculating B6 weighted coral health by geno, echo=FALSE }
