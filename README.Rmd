...
**Carl’s Hill 6-Month Survey: Ranking Genotypes by Mortality Rate**
...
carl6_losses_pretty%>% rename("Species" = species, 
                       "Geno" = geno, 
                       "# Outplanted" = num_outplanted, 
                       "# Survived" = num_survived, 
                       "Mortality Rate" = mortality_rate) %>%
...
The plot below identifies the range of tissue health by genotype.  The presence of a few outliers help to confirm the average health statistics are representative of each geno's viability.
...
There are a variety of stressors that are detrimental to the success of coral growth.  The majority of these, especially disease and predation, are out of the control of restoration efforts.  Bottom contract--a stressor caused from agitation against the seafloor--typically occurs when corals break free from their placements.  While this is unavoidable during storms or wind-reversals, there is an opportunity to reduce the amount of overall bottom contract events with improved adhesives.  New adhesive technologies are expected to be introduced in 2023.  It will be interesting to compare the percentage of Bottom Contact observations across future outplanting sites if new technologies improve.
...
c3bottom_perc %>% rename("# Outplanted" = N_Outplanted,
...
c6bottom_perc %>% rename("# Outplanted" = N_Outplanted,
                       "Total Stressors" = Total_Stressors,
                        "Bottom Contact" = Bottom_Contact,
                       "Precent of Total" = Percent_of_Total) %>%
  pander()
...
yb3bottom_perc %>% rename("# Outplanted" = N_Outplanted,
                       "Total Stressors" = Total_Stressors,
                        "Bottom Contact" = Bottom_Contact,
                       "Precent of Total" = Percent_of_Total) %>%
  pander()
