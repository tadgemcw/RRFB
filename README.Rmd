...
```
The following charts highlight the changes in ecological footprints and total coral coverage from year to year.  Data was used from BRRF's long-term surveys, which includes calculations from photomosaics of sites.
...
To better visualize the change in tissue health, I have included the average tissue health for each genotype during the three- and six-month surveys. Comparing and combining the changes with other Apal sites may help create a more diverse sample and reduce site bias.
...
At Yellowman B, BRRF outplanted different genotypes from Yellowman A.  Only geno #1 overlaps between Yellowman A and Yellowman B.
