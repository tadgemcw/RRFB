...
All calculations and visualizations are performed using R.  R packages for this project include readxl, tidyverse, pander, flextable, and rempsyc.  The report is formatted in Markdown, and all versions have been pushed to a github repository.
...
```
The following visuals highlight the changes in ecological footprints and total coral coverage from year to year.  Data from BRRF's long-term surveys was used for this section.  Since new outplanting sites are created each year, not all sites have been surveyed equally.  
