...
Apart from the mortality rate, an important universal metric included in the survey is to record the percentage of healthy coral tissue for each observation.  Predation, disease, and other environmental factors are detrimental to coral growth.  Below, I have created a weighted average of tissue health by genotype.  Note that the weighted average of tissue health does not include dead observations. [^1]
...
In the visual below, I have extracted the genotypes which are present at both the Yellowman A and Yellowman C sites.  The data suggests that the corals at Yellowman A out perform those at Yellowman C.  One noteworthy difference is that the Yellowman A survey was conducted in June 2021 while the Yellowman C survey was conducted in November 2022.  Seasonal water temperatures would have differed, creating a potentially unequal environment for comparison.
...
The percentage of Bottom Contact stressors declines greatly between the three- and six-month surveys.  It seems plausible that the addition of a stronger adhesive could plan an important role in maintaining stability as new corals establish their natural connections with the environment. 
