...
ggplot(carl3_agg, aes(x=factor(geno), y=mortality_rate)) +
...
ggplot(carl6_agg, aes(x=factor(geno), y=mortality_rate)) +
  geom_col(fill = "deepskyblue4") +
  scale_y_continuous(limits = c(-10,80), labels=scales::percent_format(scale=1)) +
  labs(x="Genotype", 
       y="Mortality Rate",
...
ggplot(yellowmanA3_agg, aes(x=factor(geno), y=mortality_rate)) +
  geom_col(fill = "deepskyblue4") +
  scale_y_continuous(limits = c(-10,80), labels=scales::percent_format(scale=1)) +
  labs(x="Genotype", 
       y="Mortality Rate",
...
ggplot(yellowmanA6_agg, aes(x=factor(geno), y=mortality_rate)) +
  geom_col(fill = "deepskyblue4") +
  scale_y_continuous(limits = c(-10,80), labels=scales::percent_format(scale=1)) +
  labs(x="Genotype", 
       y="Mortality Rate",
...
ggplot(yellowmanB3_agg, aes(x=factor(geno), y=mortality_rate)) +
  geom_col(fill = "deepskyblue4") +
  scale_y_continuous(limits = c(-10,80), labels=scales::percent_format(scale=1)) +
  labs(x="Genotype", 
       y="Mortality Rate",
...
ggplot(yellowmanB6_agg, aes(x=factor(geno), y=mortality_rate)) +
  geom_col(fill = "deepskyblue4") +
  scale_y_continuous(limits = c(-10,80), labels=scales::percent_format(scale=1)) +
  labs(x="Genotype", 
       y="Mortality Rate",
...
ggplot(yellowmanC3_agg, aes(x=factor(geno), y=mortality_rate)) +
  geom_col(fill = "deepskyblue4") +
  scale_y_continuous(limits = c(-10,80), labels=scales::percent_format(scale=1)) +
  labs(x="Genotype", 
       y="Mortality Rate",
