---
title: "Improving Reef Resilience and Diversity with Portfolio Analysis"
subtitle: "Analysis of Coral Restoration Efforts with Reef Renewal Bonaire"
...
Because the sample size of some genotypes is limited, I use bootstrapping to artificially expand the sample size.  Each genotype group is randomly sampled 1000 times with replacement.  The result is a larger sample of the original data; and through the Central Limit Theorem, the bootstrapped data approaches a more normal distribution.  With normally distributed samples, the average returns will closely resemble the sample means, but the risk factors (standard deviations) used for portfolio analysis is more representative of the population.
...
opt <- optimize.portfolio(acer.returns.wide,
                          portfolio = port_spec,
...
opt
chart.Weights(opt)
chart.RiskReward(opt, risk.col = "StdDev", return.col = "mean", chart.assets = FALSE,
