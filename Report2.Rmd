...
All calculations and visualizations are performed using R.  R packages for this project include *knitr*, *readxl*, *tidyverse*, *flextable*, *rempsyc*, and *plotly*.  The report is formatted in Markdown, and all versions have been pushed to a GitHub repository.
